...
PAD_TO = 200 
PAD_VALUE = -3
TRAIN_DF = '/content/drive/Shareddrives/ESS_Unicamp_CPqD/SER - projeto representation learning/Few-Shot_SER/experiments/train-it-es/train.csv' # The path to a csv file with "wav_path" and "emotion" columns, for training (only two languages)
TEST_DF = '/content/drive/Shareddrives/ESS_Unicamp_CPqD/SER - projeto representation learning/Few-Shot_SER/experiments/train-it-es/test.csv' # The same as training but with only data from the out-of-distribution language
