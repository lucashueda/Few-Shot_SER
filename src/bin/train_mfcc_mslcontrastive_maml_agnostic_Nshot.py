...
from src.meta_learner.contrastive_msl_meta_learner import Meta
...
PAD_TO = 200 
PAD_VALUE = -1
TRAIN_DF = '/content/drive/Shareddrives/ESS_Unicamp_CPqD/SER - projeto representation learning/Few-Shot_SER/experiments/agnostic_msl_contrastive/train.csv' # The path to a csv file with "wav_path" and "emotion" columns, for training (only two languages)
TEST_DF = '/content/drive/Shareddrives/ESS_Unicamp_CPqD/SER - projeto representation learning/Few-Shot_SER/experiments/agnostic_msl_contrastive/test.csv' # The same as training but with only data from the out-of-distribution language
