...
PAD_TO = 200 
PAD_VALUE = -1
TRAIN_DF = '/content/drive/Shareddrives/ESS_Unicamp_CPqD/SER - projeto representation learning/Few-Shot_SER/experiments/agnostic_contrastive/train.csv' # The path to a csv file with "wav_path" and "emotion" columns, for training (only two languages)
TEST_DF = '/content/drive/Shareddrives/ESS_Unicamp_CPqD/SER - projeto representation learning/Few-Shot_SER/experiments/agnostic_contrastive/test.csv' # The same as training but with only data from the out-of-distribution language
...
K_QRY = 15 # How many example per class for validation (query set)
...
LOG_PATH = "/content/drive/Shareddrives/ESS_Unicamp_CPqD/SER - projeto representation learning/Few-Shot_SER/experiments/agnostic_contrastive" # Path to log the checkpointsmen
RESTORE_PATH = None
